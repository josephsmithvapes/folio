...
const A = "#1a2d4f"; // accent — deep navy (replaces cyan)
const BG = "#f0ece0"; // background — cream
const TEXT = "#0a0f1e"; // primary text — dark navy
const MUTED = "rgba(10,15,30,0.5)";
...
export default function SkillsSection() {
  ...
  return (
    <div style={{
      background: BG,
      backgroundImage: "radial-gradient(circle at 20% 50%, rgba(26,45,79,0.07) 0%, transparent 60%)",
      ...
      <div style={{
        ...
        backgroundImage: "linear-gradient(rgba(26,45,79,0.07) 1px, transparent 1px), linear-gradient(90deg, rgba(26,45,79,0.07) 1px, transparent 1px)",
        ...
        {SKILLS.map((s) => {
          ...
          return (
            <button key={s.id} onClick={() => open(s.id)}
              style={{
                background: "rgba(26,45,79,0.04)", border: "1px solid rgba(26,45,79,0.15)",
              ...
              onMouseEnter={e => { e.currentTarget.style.background="rgba(26,45,79,0.09)"; e.currentTarget.style.borderColor="rgba(26,45,79,0.35)"; }}
              onMouseLeave={e => { e.currentTarget.style.background="rgba(26,45,79,0.04)"; e.currentTarget.style.borderColor="rgba(26,45,79,0.15)"; }}
            >
      ...
      {active && skill && (
        <div style={{
          ...
          background: "rgba(220,215,200,0.9)",
          backdropFilter: "blur(8px)",
          display: "flex", alignItems: "center", justifyContent: "center",
          padding: 16
        }}>
          <div ref={modalRef} style={{
            background: BG, border: "1px solid rgba(26,45,79,0.22)", borderRadius: 4,
            width: "100%", maxWidth: 600, position: "relative", overflow: "hidden",
            boxShadow: "0 8px 48px rgba(26,45,79,0.1), 0 0 1px rgba(26,45,79,0.2)"
          }}>
            <div style={{
              position: "absolute", inset: 0, pointerEvents: "none",
              backgroundImage: "linear-gradient(rgba(26,45,79,0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(26,45,79,0.05) 1px, transparent 1px)",
              backgroundSize: "32px 32px"
            }}/>
            <Corner pos="tl"/><Corner pos="tr"/><Corner pos="bl"/><Corner pos="br"/>

            {/* Header */}
            <div style={{ padding: "24px 24px 16px", borderBottom: "1px solid rgba(26,45,79,0.1)", position: "relative" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                ...
                <button onClick={close} style={{
                  background: "none", border: "1px solid rgba(26,45,79,0.2)", color: A,
            ...
            {/* Step indicators */}
            <div style={{ display: "flex", borderBottom: "1px solid rgba(26,45,79,0.1)" }}>
              {skill.steps.map((s, i) => (
                <button key={i} onClick={() => goStep(i)} style={{
                  flex: 1, padding: "12px 8px", background: step===i ? "rgba(26,45,79,0.07)" : "transparent",
                  border: "none", borderRight: i<2 ? "1px solid rgba(26,45,79,0.1)" : "none",
                  borderBottom: step===i ? `2px solid ${A}` : "2px solid transparent",
                  cursor: "pointer", textAlign: "center"
                }}>
                  <div style={{ color: step===i ? A : "rgba(26,45,79,0.28)", fontFamily: "monospace", fontSize: 10, letterSpacing: 2 }}>
            ...
            <div style={{ padding: "32px 24px 28px", display: "flex", gap: 24, alignItems: "flex-start", position: "relative" }}>
              <div key={`${active}-${step}-${animKey}`} style={{
                ...
                display: "flex", alignItems: "center", justifyContent: "center",
                border: "1px solid rgba(26,45,79,0.1)", borderRadius: 2, background: "rgba(26,45,79,0.04)"
              }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ color: "rgba(10,15,30,0.6)", fontSize: 14, fontFamily: "Georgia, serif", lineHeight: 1.7 }}>
            ...
            <div style={{ padding: "0 24px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <button onClick={() => goStep(Math.max(0, step-1))} disabled={step===0} style={{
                background: "none", border: `1px solid rgba(26,45,79,${step===0?0.1:0.22})`,
                color: step===0 ? "rgba(26,45,79,0.22)" : A,
              ...
              <div style={{ display: "flex", gap: 8 }}>
                {skill.steps.map((_,i) => (
                  <div key={i} onClick={() => goStep(i)} style={{
                    ...
                    background: i===step ? A : "rgba(26,45,79,0.18)",
              ...
              <button onClick={() => goStep(Math.min(skill.steps.length-1, step+1))}
                ...
                style={{
                  background: step===skill.steps.length-1 ? "none" : "rgba(26,45,79,0.07)",
                  border: `1px solid rgba(26,45,79,${step===skill.steps.length-1?0.1:0.22})`,
                  color: step===skill.steps.length-1 ? "rgba(26,45,79,0.22)" : A,
                  fontFamily: "monospace", fontSize: 11, padding: "6px 16px",
            ...
            {/* Footer */}
            <div style={{ borderTop: "1px solid rgba(26,45,79,0.07)", padding: "8px 24px", display: "flex", justifyContent: "space-between" }}>
